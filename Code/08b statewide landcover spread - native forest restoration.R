...
infest_val <- 2000
#susceptible_values 
suscep <- as.integer(c(1:2, 30:36)) + 1000
#spread_rate 
...
LC[LC %in% 8:15] <- 1000  # only add 1000 because an extra 1000 is added below for pixels in protected areas
...
save.image("H:/My Drive/Projects/PICASC Land-to-sea/Data/Intermediate/Water yield/07 statewide landcover spread/sim_1_to_1000_nativeForestRestoration.RData")
...
for (i in 1:simlength) {
  ...
  writeRaster(last_raster, paste0("H:/My Drive/Projects/PICASC Land-to-sea/Data/Processed/Water yield/07 statewide landcover spread/rasters/Native forest restoration - 7.5 pct spread rate - landcover rasters/finalRRaster",

...
# load baseline LC
raster_baseline <- raster("H:/My Drive/Projects/PICASC Land-to-sea/Data/Raw/Water yield/baselineagroforestry/baselineagroforestry_snapped1.tif")
...
rasterStack_baseline <- raster::stack(rasters_climate)
...
writeRaster(ET_predicted, filename = 'H:/My Drive/Projects/PICASC Land-to-sea/Data/Intermediate/Water yield/05 agroforestry rasters/05_agroforestry_baselineET.tif',
            overwrite = TRUE)

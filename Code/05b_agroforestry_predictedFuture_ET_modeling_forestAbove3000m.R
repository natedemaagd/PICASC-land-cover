...
# load future LC
raster_futureScenario <- raster("H:/My Drive/Projects/PICASC Land-to-sea/Data/Raw/Water yield/futureagroforestscenario_forest_snapped_above3000m/futureagroforestscenario_forest_snapped_above3000m1.tif")
...
writeRaster(ET_predicted, filename = 'H:/My Drive/Projects/PICASC Land-to-sea/Data/Intermediate/Water yield/05 agroforestry rasters/05_agroforestry_predictedFutureET_forestAbove3000m.tif',
            overwrite = TRUE)
